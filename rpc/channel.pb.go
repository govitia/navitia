...
func (x *Channel) GetContentType() string {
	if x != nil {
...
func (x *Channel) GetTypes() []string {
	if x != nil {
		return x.Types
	}
	return nil
...
var file_channel_proto_rawDesc = []byte{
	...
	0x03, 0x72, 0x70, 0x63, 0x22, 0x66, 0x0a, 0x07, 0x43, 0x68, 0x61, 0x6e, 0x6e, 0x65, 0x6c, 0x12,
	...
	0x04, 0x20, 0x03, 0x28, 0x09, 0x52, 0x05, 0x74, 0x79, 0x70, 0x65, 0x73, 0x42, 0x20, 0x5a, 0x1e,
